...
<div className='ml-64 mt-2 mt-4 max-w-md'>
  <a 
    href="/About" 
    role="button" 
    className="inline-flex items-center rounded-full border-2 border-white text-white hover:bg-white hover:text-black hover:border-black focus:border-black focus:text-black px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal transition duration-150 ease-in-out focus:outline-none focus:ring-0"
  >
    Know more
    <svg 
      ...
      height="16" 
      fill="currentColor" 
      className="bi bi-arrow-right-short ml-2 transition-colors" 
      viewBox="0 0 16 16"
    >
      <path 
        fillRule="evenodd" 
